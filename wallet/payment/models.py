...
# customers, transaction, transaction_type, subscription
...
class Transaction(models.Model):
   ...
   destination_account = models.ForeignKey(PaymentAccount, on_delete=models.CASCADE, related_name = 'receiver')
